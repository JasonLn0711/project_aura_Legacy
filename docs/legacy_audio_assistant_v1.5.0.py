...
class TranscriberThread(QThread):
    ...
    def __init__(self):
        ...
        self.live_initial_prompt = "The following is a professional meeting record."
...
class AudioRecorderThread(QThread):
    ...
    def _reduce_noise_safely(self, audio_np):
        if audio_np.size < 64:
            return audio_np
    ...
    def _flush_speech_buffer(self, speech_buffer):
        ...
        if self.enable_denoise:
            try:
                audio_np = self._reduce_noise_safely(audio_np)
            except Exception as e:
    ...
    def run(self):
        ...
        while self.running:
            try:
                ...
                # Down-mix all channels into mono to avoid silent-channel issues on Pulse/pipewire virtual devices.
        ...
        # Flush any unfinished speech when stopping recording.
        speech_buffer = self._flush_speech_buffer(speech_buffer)
